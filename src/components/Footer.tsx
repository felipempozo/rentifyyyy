  ...
  return (
    <footer className="bg-rentify-dark text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-rentify-green transition-colors">
        ...
        <div className="border-t border-gray-800 pt-6 mt-6 text-gray-500 text-sm text-center">
